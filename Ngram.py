"""
Matthew Ferrer (Keigo) - 2026
Data Science Project - N-gram Model for Statistical Language Modeling
"""
...
# Sentence that hase boundaries and out of Vocabulary words
...
#=============================================================================================================
# N-gram Model Class    
#Tokenizing the text into n-grams and counting their occurrences to build a frequency distribution.
#=============================================================================================================
...
class NgramModel:
    ...
    def generate(self, seed: Sequence[str] | None = None,
        ...
        """Generate a sequence of words from the model."""
...
# ---------------------------------------------------------------------------
# Interpolated model that combines unigram, bigram, and trigram probabilities with weights.
# ---------------------------------------------------------------------------
